...
class Location(object):
    ...
    def loc_decode(self,src_str,force_swap=False):
    ...
    #        print "decoding ",location_item
            element = self.xml_dom.getElementsByTagName(location_item)
            if element:
    ...
    #                print location_item,value, loc_decode(value)
                    ...
                    decoder_logger.info ("%s %s %s",location_item,value, self.loc_decode(value))
    ...
    #                print location_item, value , loc_decode(value,True)
                    decoder_logger.info ("decoding %s",location_item)
                    decoder_logger.info ("%s %s %s", location_item, value , self.loc_decode(value,True))
        return
